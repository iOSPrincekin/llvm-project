; ModuleID = '/Users/lee/Desktop/Compiler/Learn_LLVM_12/llvm-project/llvm/lib/Transforms/Obfuscation/example/main.c'
source_filename = "/Users/lee/Desktop/Compiler/Learn_LLVM_12/llvm-project/llvm/lib/Transforms/Obfuscation/example/main.c"
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i32 %0)
  ret i32 0
}
...
!3 = !{!"clang version 12.0.0 (git@github.com:iOSPrincekin/llvm-project.git f460958227210abde112d224b8c156555321c34b)"}
